...
function createFoodSettingsRoutes() {
    ...
    const foodSettingsService =
        new FoodSettingsService();
    ...
    router.get(
        ...
        async (req, res) => {
            ...
            try {
                ...
                const settings =
                    await foodSettingsService.getSettings();
    ...
    router.post(
        ...
        async (req, res) => {
            ...
            try {
                ...
                const settings =
                    await foodSettingsService.updateSettings(
                        req.body
                    );
                ...
                console.error(
                    "Failed to update food settings:",
                    error
                );
